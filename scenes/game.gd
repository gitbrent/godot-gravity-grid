...
@onready var score_label: Label = $UI/HUD/HBoxContainer/LeftStats/StatsContainer/ScoreLabel
@onready var level_label: Label = $UI/HUD/HBoxContainer/LeftStats/StatsContainer/LevelLabel
@onready var lines_label: Label = $UI/HUD/HBoxContainer/LeftStats/StatsContainer/LinesLabel
